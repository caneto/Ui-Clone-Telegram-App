  ...
  Widget getAppBar(){
    return AppBar(
      ...
      leading: IconButton(onPressed: null, 
                         icon: Icon(Icons.sort, size: 27, color: primary), 
               ),
      actions: [
                  ...
                  Container(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        prefixIcon: Icon(LineIcons.search,color: white.withOpacity(0.5),),
                        hintText: "Busca",
                        hintStyle: TextStyle(
                          color: white.withOpacity(0.5),fontSize: 17
                        )
                      ),
    ...
    List icons = [
      {
        ...
        "label" : "Encontrar pessoas próximas"
      },
      {
